 ...
 */
final class Version20181018173242 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question RENAME COLUMN question TO body');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question RENAME COLUMN body TO question');
    }
}
