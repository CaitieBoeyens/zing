...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_ui__ = __webpack_require__(/*! jquery-ui */ "./node_modules/jquery-ui/ui/widget.js");
...
function test() {
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/autocomplete', { test: 'test' }).then(function (response) {
...
document.getElementById('userSearchBar').onkeyup = function () {
    var $data = this.value;
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/autocomplete', { term: this.value }).then(function (response) {
